...
class _StudentFormPageState extends State<StudentFormPage> {
  ...
  // Listado maestro de cinturones
  final List<Map<String, dynamic>> _belts = [
    {'id': 1, 'name': 'Blanco'},
    {'id': 2, 'name': 'Blanco Franja Amarilla'},
    {'id': 3, 'name': 'Amarillo'},
    {'id': 4, 'name': 'Amarillo Franja Verde'},
    {'id': 5, 'name': 'Verde'},
    {'id': 6, 'name': 'Verde Franja Azul'},
    {'id': 7, 'name': 'Azul'},
    {'id': 8, 'name': 'Azul Franja Roja'},
    {'id': 9, 'name': 'Rojo'},
    {'id': 10, 'name': 'Rojo Franja Negra'},
    {'id': 11, 'name': 'Negro'},
  ];
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      value: _typeIdentify,
                      items: const [
                        ComboBoxItem(value: 'RC', child: Text('Registro Civil')),
                        ComboBoxItem(value: 'TI', child: Text('Tarjeta Identidad')),
                        ComboBoxItem(value: 'CC', child: Text('Cédula Ciudadanía')),
                        ComboBoxItem(value: 'CE', child: Text('Cédula Extranjería')),
                        ComboBoxItem(value: 'PA', child: Text('Pasaporte')),
                      ],
  ...
  void _saveStudent() {
    if (_formKey.currentState!.validate()) {
      ...
      final student = StudentsEntity(
        ...
        typeIdentify: 'CC', // Opcional: podrías añadir un dropdown para esto también
